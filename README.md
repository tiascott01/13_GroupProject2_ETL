...
#### Option 1: Pandas Dataframe
  * In the third part of the transformation a contacts dataframe was created with pandas: 
    ...
    <p align="left">
    <img src="https://github.com/tiascott01/13_GroupProject2_ETL/blob/main/Images/contact_dataframe_pandas1.png" width="350", hspace="15">
    <img src="https://github.com/tiascott01/13_GroupProject2_ETL/blob/main/Images/contact_dataframe_pandas2.png" width="350", hspace="15">
